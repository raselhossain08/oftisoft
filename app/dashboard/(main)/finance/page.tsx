        ...
        <TabsContent value="overview" className="space-y-6 mt-0">
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-8">
              <Card className="border-border/40 rounded-[2.5rem] overflow-hidden bg-card/40 backdrop-blur-md shadow-sm">
                <CardHeader className="p-8">
                  <div className="flex items-center justify-between">
                    <div>
                      <CardTitle className="text-2xl font-semibold ">Connected Gateways</CardTitle>
                      <p className="text-sm font-semibold  text-muted-foreground mt-1 opacity-60">Primary Payment Settlement Nodes</p>
                    </div>
              ...
              <Card className="border-border/40 rounded-[2.5rem] overflow-hidden bg-card/40 backdrop-blur-md shadow-sm">
                <CardHeader className="p-8">
                  <CardTitle className="text-2xl font-semibold ">Tax & VAT Ledger</CardTitle>
                  <p className="text-sm font-semibold  text-muted-foreground mt-1 opacity-60">Global Jurisdictional Nexus Settings</p>
                </CardHeader>
            ...
            <div className="space-y-8">
              ...
              <Card className="border-border/40 rounded-[2.5rem] overflow-hidden bg-card/40 backdrop-blur-md shadow-sm">
                ...
                <CardContent className="space-y-6 px-6 pb-6 pt-0">
                  <div className="flex items-center justify-between">
                    <span className="text-sm font-semibold  opacity-60">Settlement_LAG</span>
                    <span className="text-xs font-semibold ">3-5_CYCLES</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-sm font-semibold  opacity-60">FX_SYNC_CHANNEL</span>
          ...
          <Card className="border-border/40 rounded-[2.5rem] overflow-hidden bg-card/40 backdrop-blur-md shadow-sm">
            <CardHeader className="p-8 border-b border-border/20 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-6">
              <div className="relative flex-1 max-w-full sm:max-w-md">
                ...
                <Input placeholder="SEARCH_LEDGER_BY_HASH_OR_IDENTITY..."
...
<TableHead className="h-14 font-semibold text-sm  opacity-50">Status</TableHead>
            ...
            <div className="space-y-8">
              <Card className="border-border/40 rounded-[2.5rem] overflow-hidden bg-primary/5 backdrop-blur-md shadow-sm">
                <CardHeader className="p-8">
                  <CardTitle className="text-lg font-semibold ">Payout_CONFIG</CardTitle>
                </CardHeader>
                <CardContent className="space-y-10 p-8 pt-0">
                  <div className="space-y-4">
                    ...
                    <div className="flex items-end gap-3 font-semibold">
                      ...
                      <span className="text-sm mb-1  opacity-40">USD_UNIT</span>
                    </div>
                  </div>
                  <div className="space-y-4">
                    <Label className="text-sm  font-semibold text-muted-foreground opacity-60">
        ...
        <TabsContent value="settings" className="space-y-8 mt-0">
          <Card className="border-border/40 rounded-[2.5rem] overflow-hidden bg-card/40 backdrop-blur-md shadow-sm">
            <CardHeader className="p-8 border-b border-border/20">
              <CardTitle className="text-2xl font-semibold ">Fiscal_PROTOCOL_CFG</CardTitle>
              <p className="text-sm font-semibold  text-muted-foreground mt-1 opacity-60">System-wide Financial Governance & Gateway Controls</p>
            </CardHeader>
            <CardContent className="p-8 space-y-10">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-8 p-6 rounded-[2rem] border border-border/40 bg-muted/10">
                <div className="space-y-2">
                  <h4 className="text-sm font-semibold ">GATEWAY_SANDBOX_MODE</h4>
              ...
              <div className="grid sm:grid-cols-2 gap-8">
                <div className="space-y-4">
                  <Label className="text-sm  font-semibold text-muted-foreground opacity-60 ml-2">Audit_INTERVAL</Label>
                ...
                <div className="space-y-4">
                  <Label className="text-sm  font-semibold text-muted-foreground opacity-60 ml-2">Base_CURRENCY</Label>
      ...
      <Dialog open={isPayoutDialogOpen} onOpenChange={setIsPayoutDialogOpen}>
        <DialogContent className="sm:max-w-3xl rounded-[2.5rem] border-border/40 bg-card/60 backdrop-blur-xl shadow-2xl p-0 flex flex-col max-h-[85vh]">
          <DialogHeader className="shrink-0 p-8 pb-4">
            ...
            <DialogTitle className="text-3xl font-semibold ">Disburse Liquidity</DialogTitle>
            <DialogDescription className="text-sm font-semibold  opacity-60 mt-1">Initiating direct fund transfer to network participant.</DialogDescription>
          </DialogHeader>
          <form id="payout-form" onSubmit={(e) => { e.preventDefault(); handleConfirmPayout(); }} className="flex-1 overflow-y-auto px-8 space-y-5 pb-4" data-lenis-prevent>
            ...
            <div className="space-y-6">
                <div className="space-y-2">
                    <Label className="text-sm font-semibold  ml-1 opacity-70">Target_IDENTITY</Label>
                    <Input 
                ...
                <div className="space-y-2">
                    <Label className="text-sm font-semibold  ml-1 opacity-70">Volume_UNIT (USD)</Label>
          ...
          <DialogFooter className="shrink-0 p-8 bg-muted/10 border-t border-border/20 flex gap-4">
            <Button type="button" variant="ghost" className="rounded-[1.2rem] h-12 px-6 font-semibold text-sm   opacity-60 hover:opacity-100 flex-1" onClick={() => setIsPayoutDialogOpen(false)}>ABORT_DISBURSE</Button>
      ...
      <Dialog open={isScheduleDialogOpen} onOpenChange={setIsScheduleDialogOpen}>
        <DialogContent className="sm:max-w-3xl rounded-[2.5rem] border-border/40 bg-card/60 backdrop-blur-xl shadow-2xl p-0 flex flex-col max-h-[85vh]">
          <DialogHeader className="shrink-0 p-8 pb-4">
            ...
            <DialogTitle className="text-3xl font-semibold ">Cycle_SYNC_CFG</DialogTitle>
            <DialogDescription className="text-sm font-semibold  opacity-60 mt-1">Configure automated disbursement frequency for network nodes.</DialogDescription>
          </DialogHeader>
          ...
          <DialogFooter className="shrink-0 p-8 bg-muted/10 border-t border-border/20 flex gap-4">
            <Button type="button" variant="ghost" className="rounded-[1.2rem] h-12 px-6 font-semibold text-sm   opacity-60 hover:opacity-100 flex-1" onClick={() => setIsScheduleDialogOpen(false)}>CANCEL_MOD</Button>
